# category mapping 한 데이터 중에서 카테고리에 맵핑된 숫자가 겹치는 경우 하나로 합쳐줌. 그리고 오름차순으로 정렬함.
...
with open(os.path.join(DATA_PATH, "data_key15(category_numbering).txt"), 'rt', encoding='UTF8') as f:
...
f = open(os.path.join(DATA_PATH, "data_key15(category_number_sorting).txt"), 'w', encoding='UTF8')
